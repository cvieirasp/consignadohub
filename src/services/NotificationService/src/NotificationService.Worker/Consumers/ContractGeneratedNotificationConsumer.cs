...
/// <summary>
/// Consumer responsible for handling ContractGeneratedEvent messages from RabbitMQ. 
/// It ensures idempotent processing using the inbox pattern and delegates the actual 
/// notification sending to the NotificationHandler.
/// </summary>
